...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--isv_ext_product_id', default="", type=str, help="Value for the IsvExtProductID property. Defaults to empty string")
    arg_parser.add_argument('--isv_family_id', default="", type=str, help="Value for the IsvFamilyID property. Defaults to empty string.")
